<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","backgroundAttachment":"fixed","alignItems":"center","background":"url(http://codegen.caihongy.cn/20220722/1195f2dcf1544b18b524a3cd4301612c.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0 0 20px","boxShadow":"0px 10px 10px 0px #CFD5F8","margin":"0 50% 0 0","borderRadius":"0","background":"#fff","width":"800px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"80px","fontSize":"22px","fontWeight":"bold"}' class="title">基于web的铁路订票管理系统注册</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 0px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"10px","background":"#CFD5F8","width":"50%","fontSize":"22px","fontWeight":"bold","height":"50px"}' type="button" class="r-btn" @click="login()">注册</button>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220722/1195f2dcf1544b18b524a3cd4301612c.png);
		...
		.rgs-form .el-input /deep/ .el-input__inner {
						...
						border-radius: 0;
						padding: 0 10px;
						box-shadow: 0px 4px 10px 0px #CFD5F8;
						outline: none;
						color: #000;
						width: 100%;
						font-size: 14px;
